...
public class VisitedCourseRepositoryTest {
    ...
    void setUp() {
        ...
        course = Course.builder()
                ...
                .travelerInfo("- 시점 : 오륙도해맞이공원 (부산 남구 오륙도로 137) <br>교통편) 경성대부경대역 24번 버스, 오륙도스카이워크 하차<br>- 종점 : 부산역 (부산 동구 중앙대로 210) <br>교통편) 부산지하철 1호선 부산역<br>- 도시 구간을 지나는 코스이므로 화장실, 매점 등 편의시설 이용이 용이함")
                .sidoCode(6)
                .sigunguCode(4)
                .brdDiv(false)
